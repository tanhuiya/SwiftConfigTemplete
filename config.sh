...
mv "../${projectName}/Temp" "../${projectName}/Classes"
mv "../${projectName}/Classes/Temp" "../${projectName}/Classes/${projectName}"
...
swiftLintPath="../${projectName}/.swiftlint.yml"
...
echo "copy to $swiftLintPath"
cp -f ./templates/.swiftlint.yml   "$swiftLintPath"
...
sed -i "" "s%__ProjectName__%${projectName}%g" "$swiftLintPath"
